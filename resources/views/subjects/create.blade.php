<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight animate-fade-in">Create Subject</h2>
                ...
                <div class="p-8">
                    <form action="{{ route('subjects.store') }}" method="POST">
                        ...
                        <div class="mb-6 animate-fade-in-up" style="animation-delay: 0.1s">
                            <label for="name" class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">Subject Name</label>
                        ...
                        <div class="mb-8 animate-fade-in-up" style="animation-delay: 0.2s">
                            ...
                            <textarea name="description" id="description" rows="4" class="w-full rounded-xl border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 transition-all duration-200">{{ old('description') }}</textarea>
