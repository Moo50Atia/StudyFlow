...
def main():
    queries = [
        "Ragab Algablawy Dakahlia STEM School",
        "Basma Mohamed Dakahlia STEM School",
        "Basma Elsayed Dakahlia STEM School",
        "Ragab Algablawy LinkedIn",
        "Basma Mohamed STEM LinkedIn",
        "Basma Elsayed STEM LinkedIn"
    ]
    ...
    with open('names_results.txt', 'w', encoding='utf-8') as f:
    ...
    print("Names search completed. Saved to names_results.txt")
