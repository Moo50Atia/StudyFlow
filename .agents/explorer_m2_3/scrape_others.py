...
def main():
    queries = [
        ...
        "Basma Mohamed Dakahlia",
        "Basma Mohamed LinkedIn STEM",
        "Dakahlia STEM School principal",
        "Dakahlia STEM School director"
    ]
    ...
    with open('others_results.txt', 'w', encoding='utf-8') as f:
    ...
    print("Others search completed. Saved to others_results.txt")
