        ...
        if response.status_code == 200:
            ...
            for r in soup.find_all('div', class_='result'):
                ...
                if title_elem:
                    ...
                    # Parse real link from DDG redirect if needed, or just keep as is
...
def main():
    ...
    with open('ddg_results.txt', 'w', encoding='utf-8') as f:
    ...
    print("Scraping completed. Results saved to ddg_results.txt")
